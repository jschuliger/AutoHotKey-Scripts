...
;to get it to move spotify, I had to pause the song to get the spotify window to just be "Spotify"
...
;-------------------------------
Numpad1::	;keybind key (runs everything until final return)
...
ControlFocus,WindowsForms10.Window.8.app.0.2fc056_r6_ad11 , % wintitle
ControlSend,WindowsForms10.Window.8.app.0.2fc056_r6_ad11 ,{Left}, % wintitle
return 

NumpadMult::	;turn page backwards (right)
ControlFocus,WindowsForms10.Window.8.app.0.2fc056_r6_ad11 , % wintitle
ControlSend,WindowsForms10.Window.8.app.0.2fc056_r6_ad11 ,{Right}, % wintitle
return 
...
;-------------------------------
;double click fix (if mouse clicks to fast, cancel the click)
;-------------------------------
...
;------------------------------
Numpad5::	;keybind to show gui, have to run this again to open again
DetectHiddenWindows, On
